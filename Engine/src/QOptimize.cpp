...
pcl::PolygonMeshPtr QOptimize::triangulateMesh(const SurfelCloudPtr &surfels) {
...
pcl::TextureMeshPtr QOptimize::MashTextured(const pcl::PolygonMeshPtr &mesh) {
}

bool QOptimize::ICPTrack(const PointCloudPtr &source, const PointCloudPtr &target, Sophus::SE3f &Tts) {
