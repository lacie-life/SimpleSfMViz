...
void yoloDetector(cv::Mat frame,
                  ...
                  Detector &detector)
{
    //    std::string classes = "yolov4-learn/yolo/coco.names";
    //    std::string modelConfig = "yolov4-learn/yolo/yolov4.cfg";
    //    std::string modelWeights = "yolov4-learn/yolo/yolov4.weights";
